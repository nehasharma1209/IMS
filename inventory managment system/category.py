...
class categoryClass:
    def __init__(self,root):
        ...
        lbl_name=Label(self.root,text="Enter Category Name",font=("goudy old style",30),bg="honeydew1").place(x=50,y=100)
        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",18),bg="ivory3").place(x=50,y=170,width=300)

        btn_add=Button(self.root,text="Add",command=self.add,font=("goudy old style",15),bg="#4caf58",fg="white",cursor="hand2").place(x=360,y=170,width=150,height=30)
